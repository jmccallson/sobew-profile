...
import org.sobew.exceptions.ProfileExpiredSessionException;
import org.sobew.exceptions.ProfileUnauthorizationException;
...
public class ExceptionHandler {
  ...
  public static ResponseEntity<String> handleExceptions(Exception exception,
    ...
    if((exception instanceof ProfileUnauthorizationException) ||
